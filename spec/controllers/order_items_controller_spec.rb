...
describe OrderItemsController do
  ...
  describe "GET show" do
    it "assigns the requested order_item as @order_item" do
      order_item = OrderItem.create! valid_attributes
      get :show, :id => order_item.id.to_s
  ...
  describe "GET edit" do
    it "assigns the requested order_item as @order_item" do
      order_item = OrderItem.create! valid_attributes
      get :edit, :id => order_item.id.to_s
      assigns(:order_item).should eq(order_item)
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order_item" do
        ...
        OrderItem.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => order_item.id, :order_item => {'these' => 'params'}
      end

      it "assigns the requested order_item as @order_item" do
        order_item = OrderItem.create! valid_attributes
        put :update, :id => order_item.id, :order_item => valid_attributes
        assigns(:order_item).should eq(order_item)
      end
    ...
    describe "with invalid params" do
      it "assigns the order_item as @order_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        OrderItem.any_instance.stub(:save).and_return(false)
        put :update, :id => order_item.id.to_s, :order_item => {}
        assigns(:order_item).should eq(order_item)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested order_item" do
      order_item = OrderItem.create! valid_attributes
      expect {
        delete :destroy, :id => order_item.id.to_s
      }.to change(OrderItem, :count).by(-1)
    end
